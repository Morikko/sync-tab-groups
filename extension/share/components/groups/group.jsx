class Group extends React.Component {
  ...
  getGroupClasses() {
    let focusGroup = this.props.selectionFilter !== undefined
                      ? false
                      : (this.props.currentWindowId
                          === this.props.group.windowId);

    let active = this.props.selectionFilter !== undefined
      ...
      <TabList
        ...
        searchTabsResults={(
          this.props.searchGroupResult
            ...
            : undefined)} groups={this.props.groups}
