const HelpSection = React.createClass({
  ...
  render: function() {
    return (<div
      ...
      <p>
      Vestibulum maximus, lectus ac auctor vulputate, libero purus rhoncus ligula, vitae dictum neque dolor vel elit.Nunc vel ante ligula.Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;
